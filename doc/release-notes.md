...
- A proper fork of the Litecoin project on Github was made, incorporating all the changes that were in 1.1.3.0:
  - Stylecoin specific branding
  - Stylecoin specific block time, size, ...
...
- Following has been changed in comparison to the source of 1.1.3.0:
  ...
  - Changed references to "Stylecoin Wiki" to Stylecoin website
  - Changed references to stylecoin.org to stylecoin.com
  ...
  - Renamed litecoin.icns to stylecoin.icns according to config file
